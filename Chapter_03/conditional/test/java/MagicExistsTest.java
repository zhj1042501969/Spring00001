...
public class MagicExistsTest {
    ...
    @Test
    public void show(){
        AnnotationConfigApplicationContext applicationContext2 = new AnnotationConfigApplicationContext(MagicConfig.class);
        String[] beanNames = applicationContext2.getBeanDefinitionNames();
        for(String ii : beanNames){
            System.out.println("bean name is ::::"+ii);
        }
    }
